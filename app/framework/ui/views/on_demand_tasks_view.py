...
class OnDemandTasksView(QWidget):
    def __init__(self, parent=None):
        ...
        self.rightColumnWidget.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        ...
        self.gridLayout.addWidget(self.SegmentedWidget, 0, 0, 1, 2)
        self.gridLayout.addWidget(self.stackedWidget, 1, 0, 1, 1)
        self.gridLayout.addWidget(self.rightColumnWidget, 1, 1, 1, 1)
