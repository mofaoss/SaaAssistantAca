...
class FishingInterface(ModulePageBase):
    ...
    def apply_i18n(self):
        ...
        self.ComboBox_fishing_mode.addItems([
            _("High Performance (faster and more accurate, higher CPU usage)", msgid='high_performance_faster_and_more_accurate_higher_cpu_usage'),
            _("Low Performance (timeout-based auto reel, lower accuracy)", msgid='low_performance_timeout_based_auto_reel_lower_accuracy')
        ])
        ...
        self.PushButton_start_fishing.setText(_('Start Fishing', msgid='start_fishing'))
        self.TitleLabel.setText(_("Log", msgid='log'))
        self.CheckBox_is_save_fish.setText(_("Pause on new records", msgid='pause_on_new_records'))
        self.BodyLabel_7.setText(_("Color lower bound", msgid='color_lower_bound'))
        self.PrimaryPushButton_get_color.setText(_("Calibrate Color", msgid='calibrate_color'))
        self.BodyLabel.setText(_("Fishing attempts:", msgid='fishing_attempts'))
        self.CheckBox_is_limit_time.setText(_("Limit max reeling interval per attempt", msgid='limit_max_reeling_interval_per_attempt'))
        self.BodyLabel_21.setText(_("Custom fishing key", msgid='custom_fishing_key'))
        self.StrongBodyLabel.setText(_("Calibrate perfect reeling HSV (use when logs report yellow block count > 2)", msgid='calibrate_perfect_reeling_hsv_use_when_logs_report_yellow_block_count_2'))
        self.LineEdit_fish_key.setPlaceholderText(_("Fishing key is bound to in-game dodge key", msgid='fishing_key_is_bound_to_in_game_dodge_key'))
        self.BodyLabel_6.setText(_("Color upper bound", msgid='color_upper_bound'))
        self.BodyLabel_5.setText(_("Base HSV", msgid='base_hsv'))
        self.BodyLabel_2.setText(_("Fishing mode", msgid='fishing_mode'))
        self.PushButton_reset.setText(_("Reset", msgid='reset'))
        self.BodyLabel_23.setText(_("Bait type:", msgid='bait_type'))
